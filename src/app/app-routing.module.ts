...
const routes: Routes = [
  ...
  { path: "personalArea", component: PersonalAreaComponent, outlet: "navbar" },
  {
    ...
    children: [
      {
        path: "",
        redirectTo: "/(navbar:admin/(admin:consultaions))",
        pathMatch: "full"
      },
      {
        path: "consultaions",
        component: ConsultationsTableComponent,
        outlet: "admin"
      },
      ...
      { path: "roles", component: RoleTableComponent, outlet: "admin" },
      {
        ...
        component: SpecializationTableComponent,
        outlet: "admin"
      },
      {
        path: "specializationsOfEmployees",
        component: SpecializationOfEmployeeTableComponent,
        outlet: "admin"
      },
